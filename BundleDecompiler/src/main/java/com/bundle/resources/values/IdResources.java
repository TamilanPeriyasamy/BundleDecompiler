...
public class IdResources extends Resources {
	...
	public IdResources() throws ParserConfigurationException {
	...
	public void parseIdResources(File currentXmlFile)  throws Exception {
		...
		while((currentLine =bufferedReader.readLine()) != null){
			...
			if (currentLine.trim().startsWith(Resources.mParseResourceEntry +ApplicationResources.mApplicationId)) {
			...
			}else if (currentLine.trim().startsWith("(") && ( currentLine.contains(" (id) "))) {
				...
				System.err.println(IdResources.class.getCanonicalName()+" "+currentLine);
			}
		}
