...
public class IntegerResources extends Resources {
	...
	public IntegerResources() throws ParserConfigurationException {
	...
	public void parseIntegerResources(File currentXmlFile)  throws Exception {
