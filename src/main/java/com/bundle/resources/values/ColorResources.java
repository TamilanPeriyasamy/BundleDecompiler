...
public class ColorResources extends Resources {
	...
	public ColorResources() throws ParserConfigurationException {
	...
	public void parseColorResources(File currentXmlFile) throws Exception {
		...
		while((currentLine =bufferedReader.readLine()) != null){
			...
			if (currentLine.trim().startsWith(Resources.mParseResourceEntry +ApplicationResources.mApplicationId)) {
			...
			}else if (currentLine.trim().startsWith("(") && ( currentLine.contains(") @")) || currentLine.contains(") #")) {
				String dumpValues[] = currentLine.trim().split(" ");
				...
				System.err.println(ColorResources.class.getCanonicalName()+" "+currentLine);
			}
		}
